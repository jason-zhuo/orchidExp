...
public abstract class CircuitImpl implements Circuit, DashboardRenderable {
	...
	public void sendRelayCell(RelayCell cell) {
		//System.out.println("Feng:"+cell.toString()+":sending relay cell to :"+cell.getCircuitNode().toString());
		//System.out.println("sending relay cell to :"+cell.getCircuitNode().toString());
