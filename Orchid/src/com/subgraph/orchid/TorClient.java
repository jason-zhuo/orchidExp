...
public class TorClient {
	...
	public synchronized void start() {
		...
		verifyUnlimitedStrengthPolicyInstalled();//verify
		directoryDownloader.start(directory);//download dir
		circuitManager.startBuildingCircuits();//start building//»Øµ÷
	...
	private TorInitializationListener createReadyFlagInitializationListener() {
		return new TorInitializationListener() {
			...
			public void initializationCompleted() {
				readyLatch.countDown();//share count
			}
		};
	}
